...
namespace Adventure
{
    public static class Intro
    {
        public static void IntroMain()
        {
            ...
            // Intro Action 1
            Program.Action("Time to get a good look at this place and SHINE your light ahead.\n\nEnter your command: ", "SHINE");
            ...
            // Intro Action 3
            Program.Action("\"Time to get to work,\" you say, pulling out your LOCKPICK set.\n\nEnter your command: ", "LOCKPICK");
